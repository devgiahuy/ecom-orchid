...
export default function CreateOrchid() {
    ...
    return (
        <section className="max-w-2xl mx-auto my-12 px-6 py-10 bg-white rounded-3xl shadow-lg">
            ...
            <form onSubmit={formik.handleSubmit} className="flex flex-col gap-10">
                ...
                <div className="flex items-center justify-between">
                    <label className="text-gray-700 dark:text-gray-300">Là hoa tự nhiên?</label>
                    <Switch
                        name="isNatural"
                        color="success"
                        isSelected={formik.values.isNatural}
                        onValueChange={(checked) => formik.setFieldValue("isNatural", checked)}
                    />
                </div>
